...
setUp(){
  ...
  chmod 0644 ./DELETE_THIS_FILE_WHEN_SEEN
  touch ./DELETE_THIS_FILE_WHEN_SEEN_EXEC
  chmod 0111 ./DELETE_THIS_FILE_WHEN_SEEN_EXEC
}
...
test_if_file_executable(){
  if_file_executable ./DELETE_THIS_FILE_WHEN_SEEN_EXEC
  generated=$RAGUEL_IF_EQUAL_STATE
  expected='true'
  assertEquals "${expected}" "${generated}"

  generated=`if_file_executable ./DELETE_THIS_FILE_WHEN_SEEN then_run "echo 'A'"`
  expected=''
  assertEquals "${expected}" "${generated}"

  if_file_executable ./DELETE_THIS_FILE_WHEN_SEEN
  generated=$RAGUEL_IF_EQUAL_STATE
  expected='false'
  assertEquals "${expected}" "${generated}"
}
...
test_if_not_file_executable(){
  if_not_file_executable ./DELETE_THIS_FILE_WHEN_SEEN_EXEC
  generated=$RAGUEL_IF_EQUAL_STATE
  expected='false'
  assertEquals "${expected}" "${generated}"

  generated=`if_not_file_executable ./DELETE_THIS_FILE_WHEN_SEEN then_run "echo 'A'"`
  expected='A'
  assertEquals "${expected}" "${generated}"

  if_not_file_executable ./DELETE_THIS_FILE_WHEN_SEEN
  generated=$RAGUEL_IF_EQUAL_STATE
  expected='true'
  assertEquals "${expected}" "${generated}"
}
